...
st.markdown("Selectează liga și meciul pentru a genera predicții bazate pe modelele xG recente.")

# Mapare ligi Understat
LEAGUES = {
...
with col_l:
    ...
    if teams_data and dates_data:
        ...
        # Extrage toate meciurile (fără filtrare strictă)
        ...
        if upcoming_matches:
            ...
            selected_match_str = st.selectbox("Meciuri Viitoare Programate:", match_options)
            ...
            st.warning("Nu există meciuri viitoare detectate automat. Selectează manual echipele:")
